...
class Branches(models.Model):
    ...
    HOD = models.ForeignKey('accounts.Faculties', on_delete=models.SET_NULL, null=True, related_name='headed_branches')
...
class Classes(models.Model):
    ...
    class_teacher = models.ForeignKey('accounts.Faculties', on_delete=models.SET_NULL, null=True, related_name='teaching_classes')
    batch = models.ForeignKey(Batches, on_delete=models.SET_NULL, null=True, related_name='classes')
    students = models.ManyToManyField('accounts.Students', related_name='enrolled_classes', blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    modified_at = models.DateTimeField(auto_now=True)
    modified_by = models.TextField()
    is_active = models.BooleanField(default=True)
...
class Class_sub(models.Model):
    ...
    faculty = models.ForeignKey('accounts.Faculties', on_delete=models.SET_NULL, null=True, related_name='subject_classes')
    created_at = models.DateTimeField(auto_now_add=True)
    modified_at = models.DateTimeField(auto_now=True)
    modified_by = models.TextField()
    is_active = models.BooleanField(default=True)
